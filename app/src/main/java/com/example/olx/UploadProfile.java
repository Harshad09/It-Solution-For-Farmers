...
public class UploadProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtonChooseImage = findViewById(R.id.my_choose_image);
        mButtonUpload = findViewById(R.id.my_image_upload);
                           ...
                           /* Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    ImageProfileModel profile = new ImageProfileModel(aadhar, url);
                                    String uploadId = mDatabaseRef.push().getKey();
